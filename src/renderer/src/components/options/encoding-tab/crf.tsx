...
export function Crf() {
  ...
  const [crf, setCrf] = useState(preferences.video.custom.postProcessing.ffmpeg.crf)
    ...
    <div className="space-y-2 max-w-7/12">
      ...
      <Slider
        ...
        onValueCommitted={function (index) {
          ...
          if (preferences.video.custom.postProcessing.ffmpeg.crf !== i) {
            updatePreference('video.custom.postProcessing.ffmpeg.crf', i)
          }
        }}
      />
    </div>
